...
const [loading,setLoading]=useState(false)
 ...
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#008000] text-white hover:bg-[#03dd03] cursor-pointer`} onClick={handleSendOtp} disabled={loading}>
 ...
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#008000] text-white hover:bg-[#07cf07] cursor-pointer`} onClick={handleVerifyOtp} disabled={loading}>
 ...
 <div className='mb-6'>
                ...
                <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#008000] text-white hover:bg-[#09d009] cursor-pointer`} onClick={handleResetPassword} disabled={loading}>

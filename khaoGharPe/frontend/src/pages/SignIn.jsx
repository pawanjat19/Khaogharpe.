    ...
    return (
        <div className='min-h-screen w-full flex items-center justify-center p-4' style={{ backgroundColor: bgColor }}>
            <div className={`bg-white rounded-xl shadow-lg w-full max-w-md p-8 border-[1px] `} style={{
                ...
                <h1 className={`text-3xl font-bold mb-2 `} style={{ color: primaryColor }}>KhaoGharPe</h1>
            ...
            <button className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#008000] text-white hover:bg-[#03f103] cursor-pointer`} onClick={handleSignIn} disabled={loading}>

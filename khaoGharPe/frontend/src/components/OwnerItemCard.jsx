...
function OwnerItemCard({data}) {
  ...
  return (
    <div className='flex bg-white rounded-lg shadow-md overflow-hidden border border-[#008000] w-full max-w-2xl'>
...
<div className='p-2 cursor-pointer rounded-full hover:bg-[#ff4d2d]/10  text-[#008000]' onClick={()=>navigate(`/edit-item/${data._id}`)}>
<FaPen size={16}/>
</div>
